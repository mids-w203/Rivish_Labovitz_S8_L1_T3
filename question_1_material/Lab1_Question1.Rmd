...
# Are Democratic voters older of younger than Republican Voters in 2020?
...
older or younger than Republican Voters and what party they were affiliated with. 
...
```{r setting up for the test1, echo=TRUE, warning=TRUE, message=FALSE}
#Summary of Republican Voters (sd= 16.664, mean = 55.89, sample size= 1,255 )
...
Additionally, since the response variable, Age, is ordinal data, a parametric
